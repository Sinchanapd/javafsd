	 ...
	 private static void optionsSelection() 
	 {
	    ...
	    for(int j=1; j<=slen; j++)
	    {
	    	if(options == j)
	    	{
	    		switch (options)
	    		{
	            	case 1:System.out.println("Your Saved EXPENCES Are Listed Below: \n");
	                       System.out.println(expenses+ "\n");
	                       optionsSelection();
	                       break;
	                case 2:System.out.println("Enter The Values to Add Your EXPENCE: \n");
	                       ...
	                       optionsSelection();
	                       break;
	                case 3:System.out.println("You are about the delete all your EXPENCES!! \n Confirm again by selecting the same option...\n");
