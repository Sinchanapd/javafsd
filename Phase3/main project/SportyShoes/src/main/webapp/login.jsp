...
<body style="background-color: #D1FFE8;">
	...
	<div class="container">
		<div class="row topmar">
			<div class="col-6">
				<div class="contain p-3 my-3 bg-light text-black">
					<h2 style="text-align: center">User Login</h2>
					<c:if test="${regsucmessage !=null}">
						<p class="alert alert-warning">
							<c:out value="${regsucmessage}" />
						</p>
					</c:if>
					<form action="loginaction" method="post">

						<div class="form-group">
							<label for="email_id">Email:</label> <input type="text"
								class="form-control" id="email_id" placeholder="Email"
