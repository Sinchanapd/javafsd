           ...
           <section>
               <form action="${pageContext.request.contextPath}/ThankYou.jsp" method="post" class="form-container">
                   <div >
                       ...
                       Enter UPI Id<input type="text" name="name_on_card" placeholder="Enter UPI Id">
                   </div>
                   <div >
                       <label for="card_details">Mobile Number</label>
                       Enter Mobile Number<input type="number" name="card_details" placeholder="Enter Mobile Number">
                   </div>
                   <br>
